                ...
                <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                    <div class="m-l-25 m-r--38 m-lr-0-xl">
                        <div class="wrap-table-shopping-cart">
                            ...
                            <table class="table-shopping-cart">
                                <tbody><tr class="table_head">
                                    ...
                                    <th class="column-3" style="padding-left: 20px">Price</th>
                                ...
                                <tr class="table_row">
                                    ...
                                    <td class="column-3" style="padding-left: 20px">{{ number_format($price,0,'','.') }}</td>
                                    <td class="column-4">
                                    ...
                                    <td class="p-r-15">
                                        <a href="../public/carts/delete/{{$product->id}}">Xóa</a>
                                    </td>
                                </tr>
                                @endforeach
                                </tbody>
                        ...
                        <div class="flex-w flex-sb-m bor15 p-t-18 p-b-15 p-lr-40 p-lr-15-sm">
                            ...
                            <input type="submit" value="Update cart" formaction="../public/update-cart"
